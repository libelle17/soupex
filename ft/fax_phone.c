...
{
	printf("Beginn connection_status\n");
...
gboolean faxophone_connect(gpointer user_data)
{
	...
	printf("Beginn faxophone_connect, host: %s, phone-controller: %i\n",host,phonecontr);
...
again:
	...
	printf("Ende faxophone_connect, host: %s, phone-controller: %i\n",host,phonecontr);
	return session != NULL;
}
#endif
gboolean faxophone_connect(gpointer user_data)
...
{
	printf("Beginn faxophone_disconnect\n");
