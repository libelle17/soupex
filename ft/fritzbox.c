 ...
 * \return error code
 */
gboolean fbcl::fritzbox_login(/*struct profile *profile*/)
{
	if (FIRMWARE_IS(5, 50)) {
 ...
 * \return error code
 */
gboolean fbcl::fritzbox_get_settings(/*struct profile *profile*/)
{
 ...
 */
/*
gboolean fbcl::fritzbox_load_journal(*//*struct profile *profile, *//*gchar **data_ptr)
{
	gboolean ret = FALSE;
 ...
 */
/*
gboolean fbcl::fritzbox_clear_journal(struct profile *profile)
{
	if (!profile) {
		return FALSE;
	}
 ...
 */
gboolean fbcl::fritzbox_dial_number(/*struct profile *profile, */gint port, const gchar *number)
{
	if (!profile) {
		return FALSE;
	}
 ...
 * \return TRUE on success, otherwise FALSE
 */
gboolean fbcl::fritzbox_hangup(/*struct profile *profile, */gint port, const gchar *number)
{
	if (!profile) {
		return FALSE;
	}
